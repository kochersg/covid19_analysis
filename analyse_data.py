...
def plot_simulated_data(start_date:dt=None, end_date:dt=None):
    ...
    single_country = CDataTimeSeries(country = 'Germany Sim', sim_data=True, \
        ...
        days_to_recovery=12.65, extrapolate_to_date=dt(2020,8,30), \
        mortality=0.045)
...
if __name__ == "__main__":
    ...
    plot_country_collection(['Germany', 'Cyprus','Italy','Spain','United Kingdom','Denmark'], \
    ...
    plot_doubling_time_collection(['Germany', 'Cyprus', 'United Kingdom', 'Spain', 'Netherlands', 'Austria', 'Switzerland'], \
